const schemaRawData = [
    {
      ...
      data: { 
        ...
        handles: { // dla tabeli zapewne będzie to tylko port output
          input: [],
          output: [{
            portId: 'output_1',
      ...
      position: { x: 100, y: 50 }, // steps[0].ports.input[0].position
    ...
    },
    {
      ...
      data: { 
        ...
        handles: { // steps[0].resId z definicji portów tego resId
          input: [{
            portId: 'input_1',
    ...
    },
    {
      ...
      data: {
        ...
        handles: { // dla wyniku zapewne zawsze będą to dwa porty, wejście i wyjście
          input: [{
            portId: 'input_1',
    ...
    },
    {
      ...
      data: {
        ...
        handles: { // steps[1].resId z definicji portów tego resId
          input: [{
            portId: 'input_1',
    ...
    },
    {
      ...
      data: {
        ...
        handles: { // steps[2].resId z definicji portów tego resId
          input: [{
            portId: 'input_1',
    ...
    },
    {
      ...
      data: {
        ...
        handles: { // steps[3].resId z definicji portów tego resId
          input: [{
            portId: 'input_1',
            desc: "Opis portu wejściowego B1",
            type: ["table"]
    ...
    },
    {
      ...
      data: {
        ...
        handles: { // dla ostatniego wyniku zapewne zawsze będzie to tylko port wejściowy
          input: [{
            portId: 'input_1',
            desc: "Opis portu wejściowego 1",
            type: ["table"]
    ...
    },
    {
      ...
      data: {
        ...
        handles: { // steps[4].resId z definicji portów tego resId
          input: [{
            portId: 'input_1',
